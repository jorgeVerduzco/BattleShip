...
public class Server extends JFrame  {
   public JTextField enterField; // inputs message from user
   ...
   public ServerSocket server; // server socket
   public Socket connection; // connection to client
   public int counter = 1; // counter of number of connections
