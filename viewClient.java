...
public class viewClient {
    public static BattleshipModelClient clientModel = new BattleshipModelClient();
    ...
    public static void main (String[] args) {
        ...
        randomlyPlace.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                clientModel.placeShipsRandomlyOnUserBoard();
                clientModel.printUserBoard();
                ...
                JPanel userBoardPanel = makeBoard(clientModel.getUserBoard(), shipPlacements);
                JPanel opponentBoardPanel = makeBoard(clientModel.getOpponentBoard(), oppPlacements);
